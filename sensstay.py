...
def backup_game_config():
    ...
    game_name_entry = tk.Entry(window, textvariable=game_name_var)
    ...
    config_path_button = tk.Button(window, text="Select Config File", command=select_config_file)
    config_path_button.pack()
    ...
    backup_button = tk.Button(window, text="Backup Config", command=backup_config)
    backup_button.pack()
